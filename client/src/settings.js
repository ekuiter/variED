        ...
        featureDiagram: {
            ...
            treeLayout: {
                ...
                node: {
                    ...
                    baselineHeight: 5, // estimated distance of the font's baseline and descent in px (depends on font.size)
                    bboxPadding: 10, // general padding for the estimated bounding box in px (avoid "touching" the window)
