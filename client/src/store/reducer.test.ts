...
import {SERVER_RECEIVE} from '../server/actions';

describe('reducer', () => {
    const featureModelState = (state = reducer(undefined), featureModel = validFeatureModel) => {
    ...
    it('returns the initial state', () => {
        expect(reducer()).toBe(constants.store.initialState);
    });
